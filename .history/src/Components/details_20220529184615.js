            ...
            <div class="hero min-h-screen max-w-7xl px-12">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        <p class="py-6 -mt-0"><strong>Price :</strong> {productDetail.price}</p>
                        <p class="py-6 -mt-0"><strong>Quantity :</strong> {productDetail.available_quantity}</p>
                        <p class="py-6 -mt-0"><strong>Product Description :</strong> {productDetail.description}</p>
                        <p class="py-6 -mt-0"><strong>Price :</strong> {productDetail.price}</p>
