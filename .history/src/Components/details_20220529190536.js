        ...
        <div>
            ...
            <div className="order">
                ...
                <form className='grid grid-cols-1 place-items-center mt-8'>
                    ...
                    <input className='mt-4' type="text" placeholder="" class="input input-bordered input-accent w-full max-w-xs" />
                    <input className='mt-4' type="text" placeholder="Type here" class="input input-bordered input-accent w-full max-w-xs" />
                    <input className='mt-4' type="text" placeholder="Type here" class="input input-bordered input-accent w-full max-w-xs" />
                    <input className='mt-4' type="text" placeholder="Type here" class="input input-bordered input-accent w-full max-w-xs" />
                </form>
            </div>
