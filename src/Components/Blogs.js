...
const Blogs = () => {
    return (
        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-16 mx-w-7xl px-12 text-center'>
            ...
            <div class="card w-96 bg-base-100 shadow-xl mt-3">
                <div class="card-body">
                    ...
                    <p>Unit testing is a software testing method where units he individual components of softwars are tested. Developers write unit tests
                        for their code to make sure that the code works correctly and optimize their software performance easily. This helps to detect and protect against bugs in the future.
                    </p>
                </div>
            </div>
